...
if colunas1 != linhas2:
    print("Não foi possivel multiplicar pois as colunas da primeira matriz devem ser iguais as linhas da segunda matriz.")
else:
    matriz1 = np.zeros((linhas1, colunas1))
    print("Insira os ingredientes para cada lanche:")
